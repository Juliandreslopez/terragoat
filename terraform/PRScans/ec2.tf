...
EOF
  tags = merge({
    ...
    git_commit           = "b9ef3db5e2269f28dd43ab622c2a34667205b33e"
    git_file             = "terraform/PRScans/ec2.tf"
    git_last_modified_at = "2025-10-21 14:46:16"
    git_last_modified_by = "86843980+Juliandreslopez@users.noreply.github.com"
    git_modifiers        = "86843980+Juliandreslopez"
